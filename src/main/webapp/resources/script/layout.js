var app = {
    ...
    layout: {
        ...
        updateInputStyle: function (value) {
            var wrapper = this.ofClass('layout-wrapper'); 
            if (wrapper && value === 'filled' ) {
                wrapper.classList.add('ui-input-filled');
            } else {
                wrapper.classList.remove('ui-input-filled');
            }
        },
        
        updatePrimaryColor: function (value) {
            this.updateRootStyleProperty('--primary-color', value);
        },
            
        updatePrimaryColorText: function (value) {
            this.updateRootStyleProperty('--primary-color-text', value);
        },
        
        updateRootStyleProperty: function (propertyName, value) {
            document.querySelector(':root').style.setProperty(propertyName, value);
        },
    
        toggleMenu: function() {
            var content = this.ofClass('layout-content'); 
            if (content.classList.contains('topbar-active')) {
                content.classList.remove('topbar-active');
            } else {
                content.classList.add('topbar-active');
            }
        },

        leftBarToggle: function(toggled) {
            
            var content = this.ofClass('layout-content');
            if (content) {
                
                if (toggled) {
                    content.classList.remove('leftbar-open');
                    content.classList.remove('leftbar-close');
                    content.classList.remove('leftbar-close-animation');
                    content.classList.add('leftbar-open-animation');
                } else {
                    content.classList.remove('leftbar-open');
                    content.classList.remove('leftbar-close');
                    content.classList.remove('leftbar-open-animation');
                    content.classList.add('leftbar-close-animation');
                }
                
                // handle rightbar state without -x-animation
                if (content.classList.contains('rightbar-open-animation')) {
                    content.classList.remove('rightbar-open-animation');
                    content.classList.add('rightbar-open');
                }
                if (content.classList.contains('rightbar-close-animation')) {
                    content.classList.remove('rightbar-close-animation');
                    content.classList.add('rightbar-close');
                }

            }

            var leftbar = this.ofClass('layout-content-left');
            if (leftbar) {
                if (toggled) {
                    leftbar.classList.remove('leftbar-open');
                    leftbar.classList.remove('leftbar-close');
                    leftbar.classList.remove('leftbar-close-animation');
                    leftbar.classList.add('leftbar-open-animation');
                } else {
                    leftbar.classList.remove('leftbar-open');
                    leftbar.classList.remove('leftbar-close');
                    leftbar.classList.remove('leftbar-open-animation');
                    leftbar.classList.add('leftbar-close-animation');
                }
            }

        },

        rightBarToggle: function(toggled) {
            var content = this.ofClass('layout-content');
            if (content) {

                if (toggled) {
                    content.classList.remove('rightbar-open');
                    content.classList.remove('rightbar-close');
                    content.classList.remove('rightbar-close-animation');
                    content.classList.add('rightbar-open-animation');
                } else {
                    content.classList.remove('rightbar-open');
                    content.classList.remove('rightbar-close');
                    content.classList.remove('rightbar-open-animation');
                    content.classList.add('rightbar-close-animation');
                }
                
                // handle leftbar state without -x-animation
                if (content.classList.contains('leftbar-open-animation')) {
                    content.classList.remove('leftbar-open-animation');
                    content.classList.add('leftbar-open');
                }
                if (content.classList.contains('leftbar-close-animation')) {
                    content.classList.remove('leftbar-close-animation');
                    content.classList.add('leftbar-close');
                }

            }

            var rightbar = this.ofClass('layout-content-right');
            if (rightbar) {
                if (toggled) {
                    rightbar.classList.remove('rightbar-open');
                    rightbar.classList.remove('rightbar-close');
                    rightbar.classList.remove('rightbar-close-animation');
                    rightbar.classList.add('rightbar-open-animation');
                } else {
                    rightbar.classList.remove('rightbar-open');
                    rightbar.classList.remove('rightbar-close');
                    rightbar.classList.remove('rightbar-open-animation');
                    rightbar.classList.add('rightbar-close-animation');
                }
            }
